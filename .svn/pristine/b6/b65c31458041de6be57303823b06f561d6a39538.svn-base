...
HomeScreen::HomeScreen(Party& p, const Rect& pos, float z, Widget* parent) :
	...
	b = new Button(offTex, onTex, "Status",
		Color(255, 255, 255), font, Rect(25, 32, 128, 32), z, this);
	button.push_back(b);
	b = new Button(offTex, onTex, "Ability",
		Color(255, 255, 255), font, Rect(25, 64, 128, 32), z, this);
	button.push_back(b);
	b = new Button(offTex, onTex, "Equipment",
		Color(255, 255, 255), font, Rect(25, 96, 128, 32), z, this);
	button.push_back(b);
	b = new Button(offTex, onTex, "Formation",
		Color(255, 255, 255), font, Rect(25, 128, 128, 32), z, this);
	button.push_back(b);
	b = new Button(offTex, onTex, "Item",
		Color(255, 255, 255), font, Rect(25, 160, 128, 32), z, this);
	button.push_back(b);
	b = new Button(offTex, onTex, "Bestiary",
		Color(255, 255, 255), font, Rect(25, 192, 128, 32), z, this);
	button.push_back(b);
	b = new Button(offTex, onTex, "Map",
		Color(255, 255, 255), font, Rect(25, 224, 128, 32), z, this);
	button.push_back(b);
	b = new Button(offTex, onTex, "System",
		Color(255, 255, 255), font, Rect(25, 256, 128, 32), z, this);
	button.push_back(b);
...
void HomeScreen::handleInput(InputSystem& input) {	
	...
	if(input.checkKeyState("z")) {
		HomeScreenMode hsmode = (HomeScreenMode)getMode();
		switch(hsmode) {
		case HS_STATUS:
